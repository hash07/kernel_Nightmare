...
export ARCH=arm64
export CROSS_COMPILE=/home/hash/toolchain/ubertc_aarch64-4.9/bin/aarch64-linux-android-
...
function build() {
	...
	./dtbTool -s 2048 -o ${DT_IMG} -p scripts/dtc/ arch/arm/boot/dts/qcom/;
...
function clean() {
	...
	rm_if_exist ${KERNEL_PATH}/dtbTool;
